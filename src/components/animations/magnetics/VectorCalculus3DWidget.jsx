  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-4">
      <p className="text-xs text-gray-400 mb-3">
        수치 결과 <span className="text-gray-300">/ Python 중심차분법</span>
      </p>
      {loading && (
        ...
        <div className="flex flex-col gap-2">
          {mode === "gradient" && (
            <>
              ...
              <VecBadge label="∇f" vec={result.gradient} c={color} />
          ...
          {mode === "divergence" && (
            <>
              ...
              <Badge
                label="div A"
                value={`${result.divergence?.toFixed(4)}  ${result.divergence > 0.01 ? "▲ 원천" : result.divergence < -0.01 ? "▼ 싱크" : "● 비압축"}`}
              />
            </>
          )}
          {mode === "curl" && (
            <>
              ...
              <VecBadge label="∇×A" vec={result.curl} c={color} />
  ...
  return (
    <div className="w-full flex flex-col gap-6 font-body">
      ...
      <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4">
            ...
            {calc.samplesLoading && (
              <p className="text-xs text-gray-400 mt-2 flex items-center gap-1">
                <Loader2 size={10} className="animate-spin" /> 장 데이터 로드
                중...
              </p>
            )}
          </div>
              ...
              (axis) => (
                <div key={axis} className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      calc.updateProbe(axis, parseFloat(e.target.value))
                    }
        ...
        {/* 3D 뷰어 */}
        <div className="flex-1 rounded-3xl overflow-hidden relative border border-gray-200 shadow-inner min-h-[400px]">
          <Suspense
            fallback={
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-bold text-gray-400">실전 퀴즈</span>
        <div className="flex-1 h-px bg-gray-200" />
      </div>
